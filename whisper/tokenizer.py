...
class cached_property:
    ...
    def cache_clear(self):
        try:
            del self.obj.__dict__[self.cache_name]
        except (AttributeError, KeyError):
            pass

    def cache_info(self):
        try:
            cache_info = self.func.cache_info()
    ...
    def cache_parameters(self):
        try:
            cache_parameters = self.func.cache_parameters()
        except AttributeError:
            cache_parameters = None
        return cache_parameters

    def __repr__(self):
        return f"<cached_property '{self.func.__name__}'>"
